...
class BusinessController extends Controller
{
    ...
    {
        // For now, get the first enterprise linked to the business user
        // TODO: Implement proper user-enterprise linking via pivot table
        $enterprise = DB::table('enterprises')->first();
        
        if (!$enterprise) {
            abort(404, 'No enterprise found for this user');
        }
