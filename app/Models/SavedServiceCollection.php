...
class SavedServiceCollection
{
    ...
    {
        $this->items = SavedService::with(['product.enterprise', 'customizationOptions'])
     ...
     */
    public function addItem($productId, $quantity = 1, $customizations = [], $specialInstructions = null)
    {
