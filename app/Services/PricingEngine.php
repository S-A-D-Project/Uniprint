...
{
    /**
     * Calculate price for a product with customizations
     * 
     ...
     * @return array
     */
    public function calculatePrice($productId, $customizationIds = [], $quantity = 1, $enterpriseId = null)
    {
        ...
        $enterpriseId = $enterpriseId ?? $product->enterprise_id;
        ...
        foreach ($rules as $rule) {
            ...
            if ($this->evaluateRuleConditions($rule, $product, $quantity, $subtotal)) {
     ...
     */
    private function evaluateRuleConditions($rule, $product, $quantity, $subtotal)
    {
        ...
        foreach ($conditions as $condition) {
            ...
            $actualValue = $this->getFieldValue($field, $product, $quantity, $subtotal);
     ...
     */
    private function getFieldValue($field, $product, $quantity, $subtotal)
    {
        switch ($field) {
            case 'quantity':
                return $quantity;
