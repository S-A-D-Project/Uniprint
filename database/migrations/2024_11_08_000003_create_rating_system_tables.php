...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('ratings', function (Blueprint $table) {
            ...
            $table->uuid('product_id')->nullable(); // Can rate enterprise or specific product
            ...
            // Unique constraint - one rating per user per product/enterprise
            $table->unique(['user_id', 'enterprise_id', 'product_id'], 'unique_user_rating');
        });
        ...
        Schema::create('rating_summaries', function (Blueprint $table) {
            ...
            // Unique constraint
            $table->unique(['enterprise_id', 'product_id'], 'unique_rating_summary');
        });
    }
