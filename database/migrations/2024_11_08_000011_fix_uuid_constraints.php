...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        // Update products table to ensure all enterprise_id values are valid UUIDs
        DB::statement("
            UPDATE products 
        ...
        DB::statement("
            ...
            DROP CONSTRAINT IF EXISTS products_enterprise_id_uuid_check;
        ");
        
        DB::statement("
            ALTER TABLE products 
            ADD CONSTRAINT products_enterprise_id_uuid_check 
        ...
        DB::statement("CREATE INDEX IF NOT EXISTS idx_products_enterprise_id_text ON products USING btree ((enterprise_id::text));");
    ...
    public function down(): void
    {
        ...
        DB::statement("ALTER TABLE products DROP CONSTRAINT IF EXISTS products_enterprise_id_uuid_check;");
        DB::statement("ALTER TABLE enterprises DROP CONSTRAINT IF EXISTS enterprises_enterprise_id_uuid_check;");
        
        // Drop the indexes
        DB::statement("DROP INDEX IF EXISTS idx_products_enterprise_id_text;");
