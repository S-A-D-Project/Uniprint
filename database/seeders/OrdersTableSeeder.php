...
class OrdersTableSeeder extends Seeder
{
    public function run(): void
    {
        ...
        OrderItem::create([
            ...
            'product_id' => $products->where('product_name', 'Large Format Poster')->first()->product_id,
            'quantity' => 1,
            'item_subtotal' => 75.00,
        ...
        OrderItem::create([
            ...
            'product_id' => $products->where('product_name', 'Vinyl Banner')->first()->product_id,
            'quantity' => 1,
            'item_subtotal' => 55.00,
        ...
        OrderItem::create([
            ...
            'product_id' => $products->where('product_name', 'Hoodies')->first()->product_id,
            'quantity' => 3,
        ...
        OrderItem::create([
            ...
            'product_id' => $products->where('product_name', 'Brochures')->first()->product_id,
            'quantity' => 1,
            'item_subtotal' => 50.00,
