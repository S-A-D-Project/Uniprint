    ...
    <div class="w-full max-w-md space-y-6">
        ...
        <div class="bg-card border border-border rounded-xl shadow-card-hover p-6">
            ...
            <div class="grid grid-cols-2 gap-3">
                <a href="{{ route('auth.google') }}" class="flex items-center justify-center gap-2 px-4 py-2 border border-input rounded-md hover:bg-secondary transition-smooth">
                ...
                <a href="{{ route('auth.facebook') }}" class="flex items-center justify-center gap-2 px-4 py-2 border border-input rounded-md hover:bg-secondary transition-smooth">
