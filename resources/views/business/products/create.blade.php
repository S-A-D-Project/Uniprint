...
@section('page-subtitle', 'Add a new product to your catalog')
...
@section('sidebar')
    ...
    <a href="{{ route('business.products.index') }}" class="nav-link active">
    ...
    <div>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-2">
                ...
                <li class="breadcrumb-item"><a href="{{ route('business.products.index') }}">Products</a></li>
                <li class="breadcrumb-item active">Create Product</li>
            </ol>
        </nav>
    </div>
    <a href="{{ route('business.products.index') }}" class="btn btn-outline-secondary">
    ...
    <div class="col-lg-8">
        <div class="enhanced-card">
            <div class="enhanced-card-header">
                ...
                <p class="text-muted mb-0 mt-1">Fill in the details below to add a new product to your catalog</p>
            </div>
            <div class="enhanced-card-body">
                <form action="{{ route('business.products.store') }}" method="POST" class="needs-validation" novalidate>
                    @csrf
                    <div class="row">
                        <div class="col-md-8 mb-3">
                            ...
                            <input type="text" 
                                   class="form-control form-control-enhanced @error('product_name') is-invalid @enderror" 
                                   id="product_name" 
                                   name="product_name" 
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-text">
                            ...
                            A detailed description helps customers understand your product better
                        </div>
                        @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
