...
<div class="page-header d-flex justify-content-between align-items-center">
    <div>
        ...
        <p class="text-muted mb-0">
            <a href="{{ route('customer.enterprise.products', $product->enterprise_id) }}" class="text-decoration-none">
                {{ $product->enterprise->name ?? $product->enterprise_name ?? 'Unknown Enterprise' }}
            </a>
        </p>
    </div>
    <a href="{{ route('customer.enterprise.products', $product->enterprise_id) }}" class="btn btn-outline-secondary">
        ...
        <div class="card mb-4">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-start mb-3">
                    ...
                    <h2 class="text-primary mb-0">₱{{ number_format($product->base_price, 2) }}</h2>
                </div>

                <p class="text-muted">{{ $product->description_text ?? 'No description available' }}</p>
            </div>
        </div>
