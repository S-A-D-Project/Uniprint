        ...
        <div class="card h-100 border-0 shadow-sm">
            <div class="card-body">
                ...
                <p class="card-text text-muted mb-3">
                    {{ $product->description_text ? Str::limit($product->description_text, 100) : 'No description available' }}
                </p>
                ...
                <div class="mb-3">
                    <small class="text-muted">
                        ...
                        {{ $product->customizationGroups->count() }} customization options available
                    </small>
                </div>
                @endif

                <a href="{{ route('customer.product.details', $product->product_id) }}" 
