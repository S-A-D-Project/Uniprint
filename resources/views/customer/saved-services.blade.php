                            ...
                            <div class="flex gap-4">
                                ...
                                <div class="flex-1">
                                    <div class="flex justify-between items-start mb-2">
                                        <div>
                                            <h3 class="font-bold text-lg">{{ $item->product->product_name ?? 'Unknown Product' }}</h3>
                                            <p class="text-sm text-muted-foreground">{{ $item->product->enterprise->name ?? 'Unknown Shop' }}</p>
