...
<div class="container py-5">
    ...
    <div class="mb-4">
                ...
                <div class="card h-100 product-card">
                    <div class="card-body">
                        ...
                        <p class="card-text text-muted small mb-3">
                            {{ Str::limit($product->description_text, 100) }}
                        </p>
                        @endif
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            @auth
                                ...
                                <a href="{{ route('customer.product.details', $product->product_id) }}" class="btn btn-primary btn-sm">
        ...
        <div class="text-center mt-4">
            ...
            @auth
                @if(auth()->user()->role_type === 'customer')
                <a href="{{ route('customer.enterprise.products', $enterprise->enterprise_id) }}" class="btn btn-primary">
        ...
        <div class="text-center py-5">
            ...
            <h4 class="mt-3">No products available yet</h4>
