...
<body class="min-h-screen bg-background font-sans antialiased">
    <div class="flex min-h-screen">
        <!-- Sidebar -->
        <aside class="fixed inset-y-0 left-0 w-64 bg-sidebar border-r border-sidebar-hover z-50 lg:relative lg:translate-x-0 transform -translate-x-full transition-transform duration-300 ease-in-out no-print" id="sidebar">
            <div class="flex flex-col h-full">
                <!-- Logo -->
                <div class="p-6 border-b border-sidebar-hover">
                    <a href="{{ route('home') }}" class="flex items-center gap-3">
                        <div class="w-10 h-10 gradient-admin rounded-xl flex items-center justify-center shadow-glow">
                            <i data-lucide="shield-check" class="h-6 w-6 text-white"></i>
                        </div>
                        <div>
                            <h1 class="text-xl font-bold text-sidebar-foreground">UniPrint</h1>
                ...
                <nav class="flex-1 p-4 space-y-2 overflow-y-auto sidebar-nav">
                    ...
                    <div class="pt-4 mt-4 border-t border-sidebar-hover">
                        <p class="px-4 mb-2 text-xs font-semibold text-sidebar-foreground/40 uppercase tracking-wider">
                            System
                        </p>
                ...
                <div class="p-4 border-t border-sidebar-hover">
                    <div class="flex items-center gap-3 mb-3">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <p class="text-xs text-sidebar-foreground/60">System Administrator</p>
                        </div>
                    </div>
                    
                    <form action="{{ route('logout') }}" method="POST">
                        @csrf
                        <button type="submit" class="w-full flex items-center gap-2 px-3 py-2 text-sm text-sidebar-foreground/70 hover:text-sidebar-foreground hover:bg-sidebar-hover rounded-lg transition-smooth">
