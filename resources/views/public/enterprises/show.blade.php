                    ...
                    <div class="bg-card border border-border rounded-xl shadow-card hover:shadow-card-hover transition-smooth overflow-hidden group">
                        ...
                        <div class="p-6">
                            <div class="flex items-start justify-between mb-2">
                                <div>
                                    <h3 class="text-xl font-bold mb-1">{{ $service->product_name }}</h3>
                            ...
                            <div class="flex gap-2">
                                <a href="{{ route('products.show', $service->product_id) }}" 
                                ...
                                <button type="button" 
                                        ...
                                        onclick="window.location.href='{{ route('products.show', $service->product_id) }}'">
