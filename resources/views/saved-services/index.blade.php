                            ...
                            <div class="flex gap-4">
                                ...
                                <div class="flex-1">
                                    <div class="flex justify-between items-start mb-2">
                                        <div>
                                            <h3 class="font-bold text-lg">{{ $service->service->service_name ?? 'Unknown Service' }}</h3>
                                            <p class="text-sm text-muted-foreground">{{ $service->service->enterprise->name ?? 'Unknown Shop' }}</p>
